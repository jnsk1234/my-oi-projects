/*
项目名称：2048
开发工具：Visual Studio 2017，EasyX_20240601
...
public:
	...
	void update(float deltaTime)
	{
		...
		{
			currentPos.x += (targetPos.x - currentPos.x) * deltaTime * animationSpeed;
			// 相距小于 5 视为在同一位置
			...
			currentPos.y += (targetPos.y - currentPos.y) * deltaTime * animationSpeed;
